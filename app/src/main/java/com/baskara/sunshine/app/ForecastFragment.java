...
public class ForecastFragment extends Fragment {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_refresh) {
            ...
            fetchWeatherTask.execute("Jakarta");
            return true;
        }
    ...
    public class FetchWeatherTask extends AsyncTask<String, Void, String[]> {
        ...
        protected String[] doInBackground(String... params) {
            //Source: https://gist.github.com/udacityandroid/d6a7bb21904046a91695
            ...
            try {
                ...
                Uri builtUri = Uri.parse(BASE_URL).buildUpon()
                        ...
                        .appendQueryParameter(API_KEY_PARAM, "fd46595ae6d61340ff374a8c836cb256")
                        .build();

                URL url = new URL(builtUri.toString());
                //URL url = new URL("http://api.openweathermap.org/data/2.5/forecast/daily?q=surabaya&mode=json&units=metric&cnt=7&appid=fd46595ae6d61340ff374a8c836cb256");
